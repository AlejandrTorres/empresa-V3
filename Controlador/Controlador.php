...
class Controlador
{
    ...
    public function agregarPersonal($nomc, $corr, $tele, $usu, $contra, $usucar, $usuest)
    {
        ...
        if ($registros > 0) {
            echo "<script>alert('Empleado agregado con éxito'); window.location.href='index.php?accion=trabajadores';</script>";
        } else {
    ...
    public function actualizarUsuario()
    {
        if (
            ...
            if ($registros > 0) {
                echo '<script>alert("Usuario actualizado con éxito"); window.location.href="index.php?accion=trabajadores";</script>';
            } else {
